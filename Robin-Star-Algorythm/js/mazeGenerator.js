...
// weil kein hexagon und kein 8q nur 4 quare impl
...
////////////////////////////////////////////////////////////
// Alle maze generating Algos / todo: Kruskal checken
...
function maze_generators()
{
	...
	if (document.querySelector("#generator").value == "1")
		randomized_depth_first();

	else if (document.querySelector("#generator").value == "2")
		kruskal_algorithm();

	else if (document.querySelector("#generator").value == "3")
		prim_algorithm();

	else if (document.querySelector("#generator").value == "4")
		wilson_algorithm();

	else if (document.querySelector("#generator").value == "5")
		aldous_broder_algorithm();

	else if (document.querySelector("#generator").value == "6")
		recursive_division();
