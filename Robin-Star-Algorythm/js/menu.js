...
function initMenu() {
	document.querySelector("#menu").style.width = panelSize.toString(10) + "px";
	document.querySelector("#menu2").style.width = panelSize2.toString(10) + "px";
	document.querySelector("#visualizer").style.width = window.innerWidth - panelSize + borderSize - (panelSize2 + borderSize).toString(10) + "px";
	document.querySelector("#visualizer").style.height = (window.innerHeight + borderSize * 2).toString(10) + "px";
	document.querySelector("#visualizer").style.left = panelSize.toString(10) + "px";
}

function initCss() {
	document.querySelector("#grid").style.width = (cellSize * grid_size_x).toString(10) + "px";
	document.querySelector("#grid").style.height = (cellSize * grid_size_y).toString(10) + "px";
}
